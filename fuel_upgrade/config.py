...
def config_data_driven(admin_password):
    ...
    working_directory = '/var/run/fuel_backup'
    ...
    new_upgrade_version_path = join(base_config.fuel_config_path,
                                    'version.yaml')
    new_version_path = working_directory
    previous_version_path = working_directory
