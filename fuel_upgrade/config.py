...
def common_config():
    ...
    current_fuel_library_path = '/etc/puppet/'
...
def config_data_driven(admin_password):
    ...
    working_directory = '/var/lib/fuel_backup'
    ...
    fuel_uuid_path = join(base_config.fuel_config_path, 'fuel-uuid')
    ...
    fuel_ssh_config_path = '/root/.ssh'
    fuel_ssh_private_key_path = join(fuel_ssh_config_path, 'id_rsa')
    fuel_ssh_public_key_path = join(fuel_ssh_config_path, 'id_rsa.pub')
    fuel_ssh_authorized_keys_path = join(fuel_ssh_config_path,
                                         'authorized_keys')
    ...
    backup_config = {
        "target": join(working_directory, 'fuel-backup'),
        "dump": {
            "master": {
                "objects": [{
                    "path": fuel_uuid_path,
                    ...
                    "path": base_config.fuel_config_path,
                    "type": "dir"
                }, {
                    "path": base_config.current_fuel_library_path,
                    "type": "dir"
                }, {
                    ...
                    "path": fuel_ssh_authorized_keys_path,
                    "type": "file"
                }, {
                    "type": "postgres",
    ...
    return dict(base_config_dict, **locals())
